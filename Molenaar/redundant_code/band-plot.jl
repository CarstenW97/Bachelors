...
prot_c = dft.:b[idxs] + dft.:tw[idxs] + dft.:ts[idxs] + dft.:l[idxs] + dft.:r + dft.:a[idxs] + dft.:c[idxs]

band!(ax, xs, zeros(length(prot_b)), prot_b./prot_c, color=colscheme[1], label="Transporter")
band!(ax, xs, prot_b./prot_c, prot_tw./prot_c, color=colscheme[2], label="Metabolic enzyme")
band!(ax, xs, prot_tw./prot_c, prot_ts./prot_c, color=colscheme[3], label="Ribosomes")
band!(ax, xs, prot_ts./prot_c, prot_l./prot_c, color=colscheme[4], label="Lipid synthesis enzyme")
