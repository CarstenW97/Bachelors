...
FileIO.save(joinpath(imgpath, "Glutamine_synthesis_Fluxes_ATP_ADP.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Upper_Glycolysis_dG_ATP_ADP.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Glutamine_synthesis_dG_ATP_ADP.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Cofactor_Metabolites_ATP_ADP_abs.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Upper_Glycolysis_Metabolites_ATP_ADP_abs.pdf"), f)
...
FileIO.save(joinpath(imgpath, "lower_Glycolysis_Metabolites_ATP_ADP_abs.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Upper_Glycolysis_Proteome_ATP_ADP_abs.pdf"), f)
...
f[1, 2] = Legend(
    f,
    legendlabel="Enzyme",
    [[scatter1, line1], [scatter2, line2], [scatter3, line3], [scatter4, line4], [scatter1, line1]],
    ["pgk", "pgm", "pyk", "eno", "ldh"],
)
f

FileIO.save(joinpath(imgpath, "Lower_Glycolysis_Proteome_ATP_ADP_abs.pdf"), f)
...
FileIO.save(joinpath(imgpath, "Upper_Glycolysis_Fluxes_ATP_ADP_abs.pdf"), f)
